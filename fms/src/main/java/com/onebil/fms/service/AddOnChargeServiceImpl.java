...
public class AddOnChargeServiceImpl implements AddOnChargeService {
	...
	public AddOnCharge addAddonCharges(AddOnCharge addon) {
		...
		if ( addonDto!= null) {
			...
			throw new PricingException("Unable to add addon charges or record already exists");
		}
	}
	...
	public AddOnCharge updateAddonCharges(AddOnCharge addon) {
		...
		if (addonDto != null) {
			...
			throw new PricingException("Unable to update the addon charges details or no matching found to update");
		}
	}
