...
public class ProductPlanDetailsServiceImpl  implements ProductPlanDetailsService{
	...
	public ProductPlanDetails addPlanDetails(ProductPlanDetails plandetails) {
		...
		if (detailDto!= null) {
			...
			throw new PricingException("Unable to add Product plan details or record already exists");
		}
	...
	public ProductPlanDetails UpdatePlanDetails(ProductPlanDetails plandetails) {
		...
		if (detailDto != null) {
			...
			throw new PricingException("Unable to update the  Product plan details or no matching found to update");
		}
	...
	public ProductPlanDetails deletePlanDetails(int planDetailId) {
		...
		if (detailDto != null) {
			...
			throw new PricingException("Unable to delete the Product or no matching record found to delete");
		}
	}
	...
	public ProductPlanDetails getPlanDetails(int planDetailId) {
		...
		if (detailDto!= null) {
			...
			throw new PricingException("Unable to fetch the Product plan details or no matching record found to fetch");
		}
